...
window.ALT_SEED = {
  ...
  parti: {
    ...
    "envanter": [
      {
        "ad": "Şifa İksiri (Potion of Healing)",
        "id": "potion1",
        "tip": "ic",
        "adet": 2,
      ...
      {
        "ad": "Dev Balina Kehribar Yağı",
        "id": "yag",
        "tip": "detay",
        "adet": 6,
        "detay": "Dev deniz canlısından hasat edilen yoğun, amber kokulu yağ. Normal balina yağından 3 kat değerli. <br><b>Değer: Unknown<b>",
        "gizli": false,
        "etiket": ""
      },
      {
        ...
        "tip": "ic",
        "adet": 2,
        "detay": "Yontur tapınağından çıkan saklama yağı. <b>1 doz = 1 uygulama, tek kişiye, 1 saat sürer.</b><br>Etki: orman yırtıcılarına karşı <b>Stealth zarlarında avantaj</b>; vahşi bir hayvan sana <b>ilk saldırıyı başlatmaz</b> (seni \"numune değil, bakıcı dokunuşu\" sanır).<br>İnsanlara ve canavar-dışı tehditlere ise sadece stealth zarlarında avantaj verir.",
        "gizli": false,
        "etiket": ""
      },
      {
        "ad": "Mühürlü Mektup (Talas)",
        "id": "mektup",
        "tip": "mektup",
        "adet": 1,
      ...
      {
        "ad": "Binek Atı (Sezgir spiral damgalı)",
        "id": "atlar",
        "tip": "detay",
        "adet": 3,
        "detay": "S6 ganimetinden üç sağlıklı binek (Riding Horse).<br>• <b>Hız 60 ft</b> — yürüyen insandan iki kat; günlük yol mesafesini ~2 katına çıkarır.<br>• Taşıma: binici + ~200 kg yük.<br>• Savaşta eğitimsiz binek <b>ürkebilir</b> (DM takdiri; dizginlemek Animal Handling).<br><b>⚠ Damga:</b> Sezgir spirali, asayiş malı. <br><b>Değer: 75 gümüş<b><br><b>Gerçek değer: 30 gümüş<b>",
        "gizli": false,
        "etiket": "riskli"
      },
      {
        "ad": "Sergen'in Emir Kâğıdı",
        "id": "emir",
        "tip": "detay",
        "adet": 1,
      ...
      {
        "ad": "Dev Boynuzlu Soluk Boynuzu",
        "id": "oz1787755830163",
        "tip": "detay",
        "adet": 1,
        "detay": "Devasa orman yaratığının sol boynuzu <br><b>Değer: Unknown<b>",
        "gizli": false,
        "etiket": ""
      },
      {
      ...
      },
      {
        ...
        "tip": "detay",
        "adet": 1,
        "detay": "\"Anne, bugün ilk kez göreve çıkıyorum. Sayıma gidecekmişiz ama korkuyorum. Kimseyi saymak zorunda kalmam umarım.\"",
        "gizli": false,
        "etiket": ""
      },
      {
